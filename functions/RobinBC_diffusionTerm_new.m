function [A,b]=RobinBC_diffusionTerm_new(A,b,boundary,Node_number_matrix,dz,dr,T_s,alpha)
...
switch boundary
    case 'East'
        ...
        for ii=1:length(idx)
            ...
            A(idx(ii),idx(ii))=         1/(dz*dz);
            A(idx(ii),idx_W(ii))=       -(1+ alpha*dz)/(dz*dz);
    ...
    case 'West'
        ...
        for ii=1:length(idx)
            ...
            A(idx(ii),idx(ii))=     1/(dz*dz);
            A(idx(ii),idx_E(ii))=   -(1+ alpha*dz)/(dz*dz);
    ...
    case 'North'
        ...
        for ii=1:length(idx)
            ...
            A(idx(ii),idx(ii))=     1/(dr*dr);
            A(idx(ii),idx_S(ii))=   -(1+ alpha*dr)/(dr*dr);
    ...
    case 'South'
        ...
        for ii=1:length(idx)
            ...
            A(idx(ii),idx(ii))=         1/(dr*dr);
            A(idx(ii),idx_N(ii))=   -(1+ alpha*dr)/(dr*dr);
